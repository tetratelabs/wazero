...
func TestDecodeUint32(t *testing.T) {
	for _, tt := range []struct {
		...
		{name: "largest uint16", input: "65535", expected: math.MaxUint16},
		{name: "largest uint16 with underscores", input: "6_5_5_3_5", expected: math.MaxUint16},
		...
		{name: "largest uint32", input: "4294967295", expected: math.MaxUint32},
		{name: "largest uint32 with underscores", input: "4_2_9_4_9_6_7_2_9_5", expected: math.MaxUint32},
...
func TestDecodeUint64(t *testing.T) {
	for _, tt := range []struct {
		...
		{name: "zero", input: "0", expected: 0},
		{name: "largest uint32", input: "4294967295", expected: uint64(math.MaxUint32)},
		...
		{name: "largest uint64", input: "18446744073709551615", expected: math.MaxUint64},
		{name: "largest uint64 with underscores", input: "1_8_4_4_6_7_4_4_0_7_3_7_0_9_5_5_1_6_1_5", expected: math.MaxUint64},
