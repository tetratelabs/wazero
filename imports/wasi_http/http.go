...
func exportFunctions(builder wazero.HostModuleBuilder) {
	...
	exporter.ExportHostFunc(newOutgoingRequest)
	exporter.ExportHostFunc(newFields)
	exporter.ExportHostFunc(fieldsEntries)
	exporter.ExportHostFunc(dropOutgoingRequest)
	exporter.ExportHostFunc(outgoingRequestWrite)
	exporter.ExportHostFunc(dropIncomingResponse)
	exporter.ExportHostFunc(incomingResponseStatus)
	exporter.ExportHostFunc(incomingResponseHeaders)
	exporter.ExportHostFunc(incomingResponseConsume)
	exporter.ExportHostFunc(futureResponseGet)
}
