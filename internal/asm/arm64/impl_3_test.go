...
func TestAssemblerImpl_EncodeTwoRegistersToRegister(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "mvn xzr, xzr", inst: ORN, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0x3f, 0xaa}},
		{name: "mvn x10, xzr", inst: ORN, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0x3f, 0xaa}},
		{name: "mvn x30, xzr", inst: ORN, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0x3f, 0xaa}},
		{name: "orn xzr, x10, xzr", inst: ORN, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0x3f, 0xaa}},
		{name: "orn x10, x10, xzr", inst: ORN, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0x3f, 0xaa}},
		{name: "orn x30, x10, xzr", inst: ORN, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0x3f, 0xaa}},
		{name: "orn xzr, x30, xzr", inst: ORN, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0x3f, 0xaa}},
		{name: "orn x10, x30, xzr", inst: ORN, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0x3f, 0xaa}},
		{name: "orn x30, x30, xzr", inst: ORN, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0x3f, 0xaa}},
		{name: "mvn xzr, x10", inst: ORN, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0x2a, 0xaa}},
		{name: "mvn x10, x10", inst: ORN, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0x2a, 0xaa}},
		{name: "mvn x30, x10", inst: ORN, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0x2a, 0xaa}},
		{name: "orn xzr, x10, x10", inst: ORN, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0x2a, 0xaa}},
		{name: "orn x10, x10, x10", inst: ORN, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0x2a, 0xaa}},
		{name: "orn x30, x10, x10", inst: ORN, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0x2a, 0xaa}},
		{name: "orn x30, x10, x10", inst: ORN, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0x2a, 0xaa}},
		{name: "orn x10, x30, x10", inst: ORN, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0x2a, 0xaa}},
		{name: "orn x30, x30, x10", inst: ORN, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0x2a, 0xaa}},
		{name: "mvn xzr, x30", inst: ORN, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0x3e, 0xaa}},
		{name: "mvn x10, x30", inst: ORN, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0x3e, 0xaa}},
		{name: "mvn x30, x30", inst: ORN, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0x3e, 0xaa}},
		{name: "orn xzr, x10, x30", inst: ORN, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0x3e, 0xaa}},
		{name: "orn x10, x10, x30", inst: ORN, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0x3e, 0xaa}},
		{name: "orn x30, x10, x30", inst: ORN, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0x3e, 0xaa}},
		{name: "orn xzr, x30, x30", inst: ORN, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0x3e, 0xaa}},
		{name: "orn x10, x30, x30", inst: ORN, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0x3e, 0xaa}},
		{name: "orn x30, x30, x30", inst: ORN, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0x3e, 0xaa}},
		{name: "mvn wzr, wzr", inst: ORNW, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0x3f, 0x2a}},
		{name: "mvn w10, wzr", inst: ORNW, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0x3f, 0x2a}},
		{name: "mvn w30, wzr", inst: ORNW, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0x3f, 0x2a}},
		{name: "orn wzr, w10, wzr", inst: ORNW, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0x3f, 0x2a}},
		{name: "orn w10, w10, wzr", inst: ORNW, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0x3f, 0x2a}},
		{name: "orn w30, w10, wzr", inst: ORNW, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0x3f, 0x2a}},
		{name: "orn wzr, w30, wzr", inst: ORNW, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0x3f, 0x2a}},
		{name: "orn w10, w30, wzr", inst: ORNW, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0x3f, 0x2a}},
		{name: "orn w30, w30, wzr", inst: ORNW, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0x3f, 0x2a}},
		{name: "mvn wzr, w10", inst: ORNW, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0x2a, 0x2a}},
		{name: "mvn w10, w10", inst: ORNW, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0x2a, 0x2a}},
		{name: "mvn w30, w10", inst: ORNW, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0x2a, 0x2a}},
		{name: "orn wzr, w10, w10", inst: ORNW, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0x2a, 0x2a}},
		{name: "orn w10, w10, w10", inst: ORNW, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0x2a, 0x2a}},
		{name: "orn w30, w10, w10", inst: ORNW, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0x2a, 0x2a}},
		{name: "orn w30, w10, w10", inst: ORNW, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0x2a, 0x2a}},
		{name: "orn w10, w30, w10", inst: ORNW, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0x2a, 0x2a}},
		{name: "orn w30, w30, w10", inst: ORNW, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0x2a, 0x2a}},
		{name: "mvn wzr, w30", inst: ORNW, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0x3e, 0x2a}},
		{name: "mvn w10, w30", inst: ORNW, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0x3e, 0x2a}},
		{name: "mvn w30, w30", inst: ORNW, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0x3e, 0x2a}},
		{name: "orn wzr, w10, w30", inst: ORNW, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0x3e, 0x2a}},
		{name: "orn w10, w10, w30", inst: ORNW, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0x3e, 0x2a}},
		{name: "orn w30, w10, w30", inst: ORNW, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0x3e, 0x2a}},
		{name: "orn wzr, w30, w30", inst: ORNW, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0x3e, 0x2a}},
		{name: "orn w10, w30, w30", inst: ORNW, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0x3e, 0x2a}},
		{name: "orn w30, w30, w30", inst: ORNW, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0x3e, 0x2a}},
		...
		{name: "ldaddal xzr, xzr, [sp]", inst: LDADDALD, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0xff, 0xf8}},
		{name: "ldaddal xzr, x10, [sp]", inst: LDADDALD, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0xff, 0xf8}},
		{name: "ldaddal xzr, x30, [sp]", inst: LDADDALD, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0xff, 0xf8}},
		...
		{name: "ldaddal x10, xzr, [sp]", inst: LDADDALD, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0xea, 0xf8}},
		{name: "ldaddal x10, x10, [sp]", inst: LDADDALD, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0xea, 0xf8}},
		{name: "ldaddal x10, x30, [sp]", inst: LDADDALD, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0xea, 0xf8}},
		{name: "ldaddal x10, xzr, [x10]", inst: LDADDALD, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0xea, 0xf8}},
		{name: "ldaddal x10, x10, [x10]", inst: LDADDALD, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0xea, 0xf8}},
		{name: "ldaddal x10, x30, [x10]", inst: LDADDALD, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0xea, 0xf8}},
		{name: "ldaddal x10, xzr, [x30]", inst: LDADDALD, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0xea, 0xf8}},
		{name: "ldaddal x10, x10, [x30]", inst: LDADDALD, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0xea, 0xf8}},
		{name: "ldaddal x10, x30, [x30]", inst: LDADDALD, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0xea, 0xf8}},
		{name: "ldaddal x30, xzr, [sp]", inst: LDADDALD, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0xfe, 0xf8}},
		{name: "ldaddal x30, x10, [sp]", inst: LDADDALD, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0xfe, 0xf8}},
		{name: "ldaddal x30, x30, [sp]", inst: LDADDALD, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0xfe, 0xf8}},
		{name: "ldaddal x30, xzr, [x10]", inst: LDADDALD, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0xfe, 0xf8}},
		{name: "ldaddal x30, x10, [x10]", inst: LDADDALD, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0xfe, 0xf8}},
		{name: "ldaddal x30, x30, [x10]", inst: LDADDALD, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0xfe, 0xf8}},
		{name: "ldaddal x30, xzr, [x30]", inst: LDADDALD, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0xfe, 0xf8}},
		{name: "ldaddal x30, x10, [x30]", inst: LDADDALD, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0xfe, 0xf8}},
		{name: "ldaddal x30, x30, [x30]", inst: LDADDALD, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0xfe, 0xf8}},
		{name: "ldaddal wzr, wzr, [sp]", inst: LDADDALW, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0xff, 0xb8}},
		{name: "ldaddal wzr, w10, [sp]", inst: LDADDALW, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0xff, 0xb8}},
		{name: "ldaddal wzr, w30, [sp]", inst: LDADDALW, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0xff, 0xb8}},
		{name: "ldaddal wzr, wzr, [x10]", inst: LDADDALW, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0xff, 0xb8}},
		{name: "ldaddal wzr, w10, [x10]", inst: LDADDALW, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0xff, 0xb8}},
		{name: "ldaddal wzr, w30, [x10]", inst: LDADDALW, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0xff, 0xb8}},
		{name: "ldaddal wzr, wzr, [x30]", inst: LDADDALW, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0xff, 0xb8}},
		{name: "ldaddal wzr, w10, [x30]", inst: LDADDALW, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0xff, 0xb8}},
		{name: "ldaddal wzr, w30, [x30]", inst: LDADDALW, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0xff, 0xb8}},
		{name: "ldaddal w10, wzr, [sp]", inst: LDADDALW, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0xea, 0xb8}},
		{name: "ldaddal w10, w10, [sp]", inst: LDADDALW, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0xea, 0xb8}},
		{name: "ldaddal w10, w30, [sp]", inst: LDADDALW, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0xea, 0xb8}},
		{name: "ldaddal w10, wzr, [x10]", inst: LDADDALW, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0xea, 0xb8}},
		{name: "ldaddal w10, w10, [x10]", inst: LDADDALW, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0xea, 0xb8}},
		{name: "ldaddal w10, w30, [x10]", inst: LDADDALW, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0xea, 0xb8}},
		{name: "ldaddal w10, wzr, [x30]", inst: LDADDALW, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0xea, 0xb8}},
		{name: "ldaddal w10, w10, [x30]", inst: LDADDALW, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0xea, 0xb8}},
		{name: "ldaddal w10, w30, [x30]", inst: LDADDALW, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0xea, 0xb8}},
		{name: "ldaddal w30, wzr, [sp]", inst: LDADDALW, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0xfe, 0xb8}},
		{name: "ldaddal w30, w10, [sp]", inst: LDADDALW, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0xfe, 0xb8}},
		{name: "ldaddal w30, w30, [sp]", inst: LDADDALW, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0xfe, 0xb8}},
		{name: "ldaddal w30, wzr, [x10]", inst: LDADDALW, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0xfe, 0xb8}},
		{name: "ldaddal w30, w10, [x10]", inst: LDADDALW, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0xfe, 0xb8}},
		{name: "ldaddal w30, w30, [x10]", inst: LDADDALW, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0xfe, 0xb8}},
		{name: "ldaddal w30, wzr, [x30]", inst: LDADDALW, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0xfe, 0xb8}},
		{name: "ldaddal w30, w10, [x30]", inst: LDADDALW, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0xfe, 0xb8}},
		{name: "ldaddal w30, w30, [x30]", inst: LDADDALW, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0xfe, 0xb8}},
		{name: "ldaddalh wzr, wzr, [sp]", inst: LDADDALH, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0xff, 0x78}},
		{name: "ldaddalh wzr, w10, [sp]", inst: LDADDALH, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0xff, 0x78}},
		{name: "ldaddalh wzr, w30, [sp]", inst: LDADDALH, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0xff, 0x78}},
		{name: "ldaddalh wzr, wzr, [x10]", inst: LDADDALH, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0xff, 0x78}},
		{name: "ldaddalh wzr, w10, [x10]", inst: LDADDALH, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0xff, 0x78}},
		{name: "ldaddalh wzr, w30, [x10]", inst: LDADDALH, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0xff, 0x78}},
		{name: "ldaddalh wzr, wzr, [x30]", inst: LDADDALH, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0xff, 0x78}},
		{name: "ldaddalh wzr, w10, [x30]", inst: LDADDALH, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0xff, 0x78}},
		{name: "ldaddalh wzr, w30, [x30]", inst: LDADDALH, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0xff, 0x78}},
		{name: "ldaddalh w10, wzr, [sp]", inst: LDADDALH, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0xea, 0x78}},
		{name: "ldaddalh w10, w10, [sp]", inst: LDADDALH, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0xea, 0x78}},
		{name: "ldaddalh w10, w30, [sp]", inst: LDADDALH, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0xea, 0x78}},
		{name: "ldaddalh w10, wzr, [x10]", inst: LDADDALH, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0xea, 0x78}},
		{name: "ldaddalh w10, w10, [x10]", inst: LDADDALH, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0xea, 0x78}},
		{name: "ldaddalh w10, w30, [x10]", inst: LDADDALH, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0xea, 0x78}},
		{name: "ldaddalh w10, wzr, [x30]", inst: LDADDALH, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0xea, 0x78}},
		{name: "ldaddalh w10, w10, [x30]", inst: LDADDALH, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0xea, 0x78}},
		{name: "ldaddalh w10, w30, [x30]", inst: LDADDALH, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0xea, 0x78}},
		{name: "ldaddalh w30, wzr, [sp]", inst: LDADDALH, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0xfe, 0x78}},
		{name: "ldaddalh w30, w10, [sp]", inst: LDADDALH, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0xfe, 0x78}},
		{name: "ldaddalh w30, w30, [sp]", inst: LDADDALH, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0xfe, 0x78}},
		{name: "ldaddalh w30, wzr, [x10]", inst: LDADDALH, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0xfe, 0x78}},
		{name: "ldaddalh w30, w10, [x10]", inst: LDADDALH, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0xfe, 0x78}},
		{name: "ldaddalh w30, w30, [x10]", inst: LDADDALH, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0xfe, 0x78}},
		{name: "ldaddalh w30, wzr, [x30]", inst: LDADDALH, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0xfe, 0x78}},
		{name: "ldaddalh w30, w10, [x30]", inst: LDADDALH, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0xfe, 0x78}},
		{name: "ldaddalh w30, w30, [x30]", inst: LDADDALH, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0xfe, 0x78}},
		{name: "ldaddalb wzr, wzr, [sp]", inst: LDADDALB, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0xff, 0x38}},
		{name: "ldaddalb wzr, w10, [sp]", inst: LDADDALB, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0xff, 0x38}},
		{name: "ldaddalb wzr, w30, [sp]", inst: LDADDALB, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0xff, 0x38}},
		{name: "ldaddalb wzr, wzr, [x10]", inst: LDADDALB, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0xff, 0x38}},
		{name: "ldaddalb wzr, w10, [x10]", inst: LDADDALB, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0xff, 0x38}},
		{name: "ldaddalb wzr, w30, [x10]", inst: LDADDALB, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0xff, 0x38}},
		{name: "ldaddalb wzr, wzr, [x30]", inst: LDADDALB, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0xff, 0x38}},
		{name: "ldaddalb wzr, w10, [x30]", inst: LDADDALB, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0xff, 0x38}},
		{name: "ldaddalb wzr, w30, [x30]", inst: LDADDALB, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0xff, 0x38}},
		{name: "ldaddalb w10, wzr, [sp]", inst: LDADDALB, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0xea, 0x38}},
		{name: "ldaddalb w10, w10, [sp]", inst: LDADDALB, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0xea, 0x38}},
		{name: "ldaddalb w10, w30, [sp]", inst: LDADDALB, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0xea, 0x38}},
		{name: "ldaddalb w10, wzr, [x10]", inst: LDADDALB, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0xea, 0x38}},
		{name: "ldaddalb w10, w10, [x10]", inst: LDADDALB, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0xea, 0x38}},
		{name: "ldaddalb w10, w30, [x10]", inst: LDADDALB, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0xea, 0x38}},
		{name: "ldaddalb w10, wzr, [x30]", inst: LDADDALB, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0xea, 0x38}},
		{name: "ldaddalb w10, w10, [x30]", inst: LDADDALB, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0xea, 0x38}},
		{name: "ldaddalb w10, w30, [x30]", inst: LDADDALB, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0xea, 0x38}},
		{name: "ldaddalb w30, wzr, [sp]", inst: LDADDALB, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x3, 0xfe, 0x38}},
		{name: "ldaddalb w30, w10, [sp]", inst: LDADDALB, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x3, 0xfe, 0x38}},
		{name: "ldaddalb w30, w30, [sp]", inst: LDADDALB, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x3, 0xfe, 0x38}},
		{name: "ldaddalb w30, wzr, [x10]", inst: LDADDALB, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x1, 0xfe, 0x38}},
		{name: "ldaddalb w30, w10, [x10]", inst: LDADDALB, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x1, 0xfe, 0x38}},
		{name: "ldaddalb w30, w30, [x10]", inst: LDADDALB, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x1, 0xfe, 0x38}},
		{name: "ldaddalb w30, wzr, [x30]", inst: LDADDALB, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x3, 0xfe, 0x38}},
		{name: "ldaddalb w30, w10, [x30]", inst: LDADDALB, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x3, 0xfe, 0x38}},
		{name: "ldaddalb w30, w30, [x30]", inst: LDADDALB, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x3, 0xfe, 0x38}},
		{name: "ldclral xzr, xzr, [sp]", inst: LDCLRALD, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x13, 0xff, 0xf8}},
		{name: "ldclral xzr, x10, [sp]", inst: LDCLRALD, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x13, 0xff, 0xf8}},
		{name: "ldclral xzr, x30, [sp]", inst: LDCLRALD, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x13, 0xff, 0xf8}},
		...
		{name: "ldclral x10, xzr, [sp]", inst: LDCLRALD, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x13, 0xea, 0xf8}},
		{name: "ldclral x10, x10, [sp]", inst: LDCLRALD, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x13, 0xea, 0xf8}},
		{name: "ldclral x10, x30, [sp]", inst: LDCLRALD, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x13, 0xea, 0xf8}},
		{name: "ldclral x10, xzr, [x10]", inst: LDCLRALD, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x11, 0xea, 0xf8}},
		{name: "ldclral x10, x10, [x10]", inst: LDCLRALD, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x11, 0xea, 0xf8}},
		{name: "ldclral x10, x30, [x10]", inst: LDCLRALD, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x11, 0xea, 0xf8}},
		{name: "ldclral x10, xzr, [x30]", inst: LDCLRALD, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x13, 0xea, 0xf8}},
		{name: "ldclral x10, x10, [x30]", inst: LDCLRALD, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x13, 0xea, 0xf8}},
		{name: "ldclral x10, x30, [x30]", inst: LDCLRALD, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x13, 0xea, 0xf8}},
		{name: "ldclral x30, xzr, [sp]", inst: LDCLRALD, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x13, 0xfe, 0xf8}},
		{name: "ldclral x30, x10, [sp]", inst: LDCLRALD, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x13, 0xfe, 0xf8}},
		{name: "ldclral x30, x30, [sp]", inst: LDCLRALD, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x13, 0xfe, 0xf8}},
		{name: "ldclral x30, xzr, [x10]", inst: LDCLRALD, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x11, 0xfe, 0xf8}},
		{name: "ldclral x30, x10, [x10]", inst: LDCLRALD, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x11, 0xfe, 0xf8}},
		{name: "ldclral x30, x30, [x10]", inst: LDCLRALD, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x11, 0xfe, 0xf8}},
		{name: "ldclral x30, xzr, [x30]", inst: LDCLRALD, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x13, 0xfe, 0xf8}},
		{name: "ldclral x30, x10, [x30]", inst: LDCLRALD, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x13, 0xfe, 0xf8}},
		{name: "ldclral x30, x30, [x30]", inst: LDCLRALD, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x13, 0xfe, 0xf8}},
		{name: "ldclral wzr, wzr, [sp]", inst: LDCLRALW, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x13, 0xff, 0xb8}},
		{name: "ldclral wzr, w10, [sp]", inst: LDCLRALW, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x13, 0xff, 0xb8}},
		{name: "ldclral wzr, w30, [sp]", inst: LDCLRALW, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x13, 0xff, 0xb8}},
		{name: "ldclral wzr, wzr, [x10]", inst: LDCLRALW, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x11, 0xff, 0xb8}},
		{name: "ldclral wzr, w10, [x10]", inst: LDCLRALW, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x11, 0xff, 0xb8}},
		{name: "ldclral wzr, w30, [x10]", inst: LDCLRALW, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x11, 0xff, 0xb8}},
		{name: "ldclral wzr, wzr, [x30]", inst: LDCLRALW, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x13, 0xff, 0xb8}},
		{name: "ldclral wzr, w10, [x30]", inst: LDCLRALW, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x13, 0xff, 0xb8}},
		{name: "ldclral wzr, w30, [x30]", inst: LDCLRALW, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x13, 0xff, 0xb8}},
		{name: "ldclral w10, wzr, [sp]", inst: LDCLRALW, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x13, 0xea, 0xb8}},
		{name: "ldclral w10, w10, [sp]", inst: LDCLRALW, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x13, 0xea, 0xb8}},
		{name: "ldclral w10, w30, [sp]", inst: LDCLRALW, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x13, 0xea, 0xb8}},
		{name: "ldclral w10, wzr, [x10]", inst: LDCLRALW, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x11, 0xea, 0xb8}},
		{name: "ldclral w10, w10, [x10]", inst: LDCLRALW, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x11, 0xea, 0xb8}},
		{name: "ldclral w10, w30, [x10]", inst: LDCLRALW, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x11, 0xea, 0xb8}},
		{name: "ldclral w10, wzr, [x30]", inst: LDCLRALW, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x13, 0xea, 0xb8}},
		{name: "ldclral w10, w10, [x30]", inst: LDCLRALW, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x13, 0xea, 0xb8}},
		{name: "ldclral w10, w30, [x30]", inst: LDCLRALW, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x13, 0xea, 0xb8}},
		{name: "ldclral w30, wzr, [sp]", inst: LDCLRALW, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x13, 0xfe, 0xb8}},
		{name: "ldclral w30, w10, [sp]", inst: LDCLRALW, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x13, 0xfe, 0xb8}},
		{name: "ldclral w30, w30, [sp]", inst: LDCLRALW, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x13, 0xfe, 0xb8}},
		{name: "ldclral w30, wzr, [x10]", inst: LDCLRALW, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x11, 0xfe, 0xb8}},
		{name: "ldclral w30, w10, [x10]", inst: LDCLRALW, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x11, 0xfe, 0xb8}},
		{name: "ldclral w30, w30, [x10]", inst: LDCLRALW, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x11, 0xfe, 0xb8}},
		{name: "ldclral w30, wzr, [x30]", inst: LDCLRALW, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x13, 0xfe, 0xb8}},
		{name: "ldclral w30, w10, [x30]", inst: LDCLRALW, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x13, 0xfe, 0xb8}},
		{name: "ldclral w30, w30, [x30]", inst: LDCLRALW, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x13, 0xfe, 0xb8}},
		{name: "ldclralh wzr, wzr, [sp]", inst: LDCLRALH, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x13, 0xff, 0x78}},
		{name: "ldclralh wzr, w10, [sp]", inst: LDCLRALH, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x13, 0xff, 0x78}},
		{name: "ldclralh wzr, w30, [sp]", inst: LDCLRALH, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x13, 0xff, 0x78}},
		{name: "ldclralh wzr, wzr, [x10]", inst: LDCLRALH, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x11, 0xff, 0x78}},
		{name: "ldclralh wzr, w10, [x10]", inst: LDCLRALH, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x11, 0xff, 0x78}},
		{name: "ldclralh wzr, w30, [x10]", inst: LDCLRALH, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x11, 0xff, 0x78}},
		{name: "ldclralh wzr, wzr, [x30]", inst: LDCLRALH, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x13, 0xff, 0x78}},
		{name: "ldclralh wzr, w10, [x30]", inst: LDCLRALH, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x13, 0xff, 0x78}},
		{name: "ldclralh wzr, w30, [x30]", inst: LDCLRALH, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x13, 0xff, 0x78}},
		{name: "ldclralh w10, wzr, [sp]", inst: LDCLRALH, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x13, 0xea, 0x78}},
		{name: "ldclralh w10, w10, [sp]", inst: LDCLRALH, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x13, 0xea, 0x78}},
		{name: "ldclralh w10, w30, [sp]", inst: LDCLRALH, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x13, 0xea, 0x78}},
		{name: "ldclralh w10, wzr, [x10]", inst: LDCLRALH, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x11, 0xea, 0x78}},
		{name: "ldclralh w10, w10, [x10]", inst: LDCLRALH, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x11, 0xea, 0x78}},
		{name: "ldclralh w10, w30, [x10]", inst: LDCLRALH, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x11, 0xea, 0x78}},
		{name: "ldclralh w10, wzr, [x30]", inst: LDCLRALH, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x13, 0xea, 0x78}},
		{name: "ldclralh w10, w10, [x30]", inst: LDCLRALH, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x13, 0xea, 0x78}},
		{name: "ldclralh w10, w30, [x30]", inst: LDCLRALH, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x13, 0xea, 0x78}},
		{name: "ldclralh w30, wzr, [sp]", inst: LDCLRALH, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x13, 0xfe, 0x78}},
		{name: "ldclralh w30, w10, [sp]", inst: LDCLRALH, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x13, 0xfe, 0x78}},
		{name: "ldclralh w30, w30, [sp]", inst: LDCLRALH, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x13, 0xfe, 0x78}},
		{name: "ldclralh w30, wzr, [x10]", inst: LDCLRALH, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x11, 0xfe, 0x78}},
		{name: "ldclralh w30, w10, [x10]", inst: LDCLRALH, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x11, 0xfe, 0x78}},
		{name: "ldclralh w30, w30, [x10]", inst: LDCLRALH, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x11, 0xfe, 0x78}},
		{name: "ldclralh w30, wzr, [x30]", inst: LDCLRALH, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x13, 0xfe, 0x78}},
		{name: "ldclralh w30, w10, [x30]", inst: LDCLRALH, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x13, 0xfe, 0x78}},
		{name: "ldclralh w30, w30, [x30]", inst: LDCLRALH, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x13, 0xfe, 0x78}},
		{name: "ldclralb wzr, wzr, [sp]", inst: LDCLRALB, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x13, 0xff, 0x38}},
		{name: "ldclralb wzr, w10, [sp]", inst: LDCLRALB, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x13, 0xff, 0x38}},
		{name: "ldclralb wzr, w30, [sp]", inst: LDCLRALB, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x13, 0xff, 0x38}},
		{name: "ldclralb wzr, wzr, [x10]", inst: LDCLRALB, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x11, 0xff, 0x38}},
		{name: "ldclralb wzr, w10, [x10]", inst: LDCLRALB, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x11, 0xff, 0x38}},
		{name: "ldclralb wzr, w30, [x10]", inst: LDCLRALB, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x11, 0xff, 0x38}},
		{name: "ldclralb wzr, wzr, [x30]", inst: LDCLRALB, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x13, 0xff, 0x38}},
		{name: "ldclralb wzr, w10, [x30]", inst: LDCLRALB, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x13, 0xff, 0x38}},
		{name: "ldclralb wzr, w30, [x30]", inst: LDCLRALB, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x13, 0xff, 0x38}},
		{name: "ldclralb w10, wzr, [sp]", inst: LDCLRALB, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x13, 0xea, 0x38}},
		{name: "ldclralb w10, w10, [sp]", inst: LDCLRALB, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x13, 0xea, 0x38}},
		{name: "ldclralb w10, w30, [sp]", inst: LDCLRALB, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x13, 0xea, 0x38}},
		{name: "ldclralb w10, wzr, [x10]", inst: LDCLRALB, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x11, 0xea, 0x38}},
		{name: "ldclralb w10, w10, [x10]", inst: LDCLRALB, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x11, 0xea, 0x38}},
		{name: "ldclralb w10, w30, [x10]", inst: LDCLRALB, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x11, 0xea, 0x38}},
		{name: "ldclralb w10, wzr, [x30]", inst: LDCLRALB, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x13, 0xea, 0x38}},
		{name: "ldclralb w10, w10, [x30]", inst: LDCLRALB, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x13, 0xea, 0x38}},
		{name: "ldclralb w10, w30, [x30]", inst: LDCLRALB, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x13, 0xea, 0x38}},
		{name: "ldclralb w30, wzr, [sp]", inst: LDCLRALB, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x13, 0xfe, 0x38}},
		{name: "ldclralb w30, w10, [sp]", inst: LDCLRALB, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x13, 0xfe, 0x38}},
		{name: "ldclralb w30, w30, [sp]", inst: LDCLRALB, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x13, 0xfe, 0x38}},
		{name: "ldclralb w30, wzr, [x10]", inst: LDCLRALB, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x11, 0xfe, 0x38}},
		{name: "ldclralb w30, w10, [x10]", inst: LDCLRALB, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x11, 0xfe, 0x38}},
		{name: "ldclralb w30, w30, [x10]", inst: LDCLRALB, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x11, 0xfe, 0x38}},
		{name: "ldclralb w30, wzr, [x30]", inst: LDCLRALB, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x13, 0xfe, 0x38}},
		{name: "ldclralb w30, w10, [x30]", inst: LDCLRALB, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x13, 0xfe, 0x38}},
		{name: "ldclralb w30, w30, [x30]", inst: LDCLRALB, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x13, 0xfe, 0x38}},
		{name: "ldsetal xzr, xzr, [sp]", inst: LDSETALD, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x33, 0xff, 0xf8}},
		{name: "ldsetal xzr, x10, [sp]", inst: LDSETALD, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x33, 0xff, 0xf8}},
		{name: "ldsetal xzr, x30, [sp]", inst: LDSETALD, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x33, 0xff, 0xf8}},
		{name: "ldsetal xzr, xzr, [x10]", inst: LDSETALD, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x31, 0xff, 0xf8}},
		{name: "ldsetal xzr, x10, [x10]", inst: LDSETALD, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x31, 0xff, 0xf8}},
		{name: "ldsetal xzr, x30, [x10]", inst: LDSETALD, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x31, 0xff, 0xf8}},
		{name: "ldsetal xzr, xzr, [x30]", inst: LDSETALD, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x33, 0xff, 0xf8}},
		{name: "ldsetal xzr, x10, [x30]", inst: LDSETALD, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x33, 0xff, 0xf8}},
		{name: "ldsetal xzr, x30, [x30]", inst: LDSETALD, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x33, 0xff, 0xf8}},
		{name: "ldsetal x10, xzr, [sp]", inst: LDSETALD, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x33, 0xea, 0xf8}},
		{name: "ldsetal x10, x10, [sp]", inst: LDSETALD, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x33, 0xea, 0xf8}},
		{name: "ldsetal x10, x30, [sp]", inst: LDSETALD, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x33, 0xea, 0xf8}},
		{name: "ldsetal x10, xzr, [x10]", inst: LDSETALD, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x31, 0xea, 0xf8}},
		{name: "ldsetal x10, x10, [x10]", inst: LDSETALD, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x31, 0xea, 0xf8}},
		{name: "ldsetal x10, x30, [x10]", inst: LDSETALD, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x31, 0xea, 0xf8}},
		{name: "ldsetal x10, xzr, [x30]", inst: LDSETALD, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x33, 0xea, 0xf8}},
		{name: "ldsetal x10, x10, [x30]", inst: LDSETALD, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x33, 0xea, 0xf8}},
		{name: "ldsetal x10, x30, [x30]", inst: LDSETALD, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x33, 0xea, 0xf8}},
		{name: "ldsetal x30, xzr, [sp]", inst: LDSETALD, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x33, 0xfe, 0xf8}},
		{name: "ldsetal x30, x10, [sp]", inst: LDSETALD, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x33, 0xfe, 0xf8}},
		{name: "ldsetal x30, x30, [sp]", inst: LDSETALD, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x33, 0xfe, 0xf8}},
		{name: "ldsetal x30, xzr, [x10]", inst: LDSETALD, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x31, 0xfe, 0xf8}},
		{name: "ldsetal x30, x10, [x10]", inst: LDSETALD, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x31, 0xfe, 0xf8}},
		{name: "ldsetal x30, x30, [x10]", inst: LDSETALD, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x31, 0xfe, 0xf8}},
		{name: "ldsetal x30, xzr, [x30]", inst: LDSETALD, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x33, 0xfe, 0xf8}},
		{name: "ldsetal x30, x10, [x30]", inst: LDSETALD, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x33, 0xfe, 0xf8}},
		{name: "ldsetal x30, x30, [x30]", inst: LDSETALD, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x33, 0xfe, 0xf8}},
		{name: "ldsetal wzr, wzr, [sp]", inst: LDSETALW, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x33, 0xff, 0xb8}},
		{name: "ldsetal wzr, w10, [sp]", inst: LDSETALW, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x33, 0xff, 0xb8}},
		{name: "ldsetal wzr, w30, [sp]", inst: LDSETALW, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x33, 0xff, 0xb8}},
		{name: "ldsetal wzr, wzr, [x10]", inst: LDSETALW, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x31, 0xff, 0xb8}},
		{name: "ldsetal wzr, w10, [x10]", inst: LDSETALW, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x31, 0xff, 0xb8}},
		{name: "ldsetal wzr, w30, [x10]", inst: LDSETALW, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x31, 0xff, 0xb8}},
		{name: "ldsetal wzr, wzr, [x30]", inst: LDSETALW, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x33, 0xff, 0xb8}},
		{name: "ldsetal wzr, w10, [x30]", inst: LDSETALW, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x33, 0xff, 0xb8}},
		{name: "ldsetal wzr, w30, [x30]", inst: LDSETALW, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x33, 0xff, 0xb8}},
		{name: "ldsetal w10, wzr, [sp]", inst: LDSETALW, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x33, 0xea, 0xb8}},
		{name: "ldsetal w10, w10, [sp]", inst: LDSETALW, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x33, 0xea, 0xb8}},
		{name: "ldsetal w10, w30, [sp]", inst: LDSETALW, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x33, 0xea, 0xb8}},
		{name: "ldsetal w10, wzr, [x10]", inst: LDSETALW, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x31, 0xea, 0xb8}},
		{name: "ldsetal w10, w10, [x10]", inst: LDSETALW, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x31, 0xea, 0xb8}},
		{name: "ldsetal w10, w30, [x10]", inst: LDSETALW, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x31, 0xea, 0xb8}},
		{name: "ldsetal w10, wzr, [x30]", inst: LDSETALW, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x33, 0xea, 0xb8}},
		{name: "ldsetal w10, w10, [x30]", inst: LDSETALW, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x33, 0xea, 0xb8}},
		{name: "ldsetal w10, w30, [x30]", inst: LDSETALW, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x33, 0xea, 0xb8}},
		{name: "ldsetal w30, wzr, [sp]", inst: LDSETALW, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x33, 0xfe, 0xb8}},
		{name: "ldsetal w30, w10, [sp]", inst: LDSETALW, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x33, 0xfe, 0xb8}},
		{name: "ldsetal w30, w30, [sp]", inst: LDSETALW, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x33, 0xfe, 0xb8}},
		{name: "ldsetal w30, wzr, [x10]", inst: LDSETALW, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x31, 0xfe, 0xb8}},
		{name: "ldsetal w30, w10, [x10]", inst: LDSETALW, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x31, 0xfe, 0xb8}},
		{name: "ldsetal w30, w30, [x10]", inst: LDSETALW, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x31, 0xfe, 0xb8}},
		{name: "ldsetal w30, wzr, [x30]", inst: LDSETALW, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x33, 0xfe, 0xb8}},
		{name: "ldsetal w30, w10, [x30]", inst: LDSETALW, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x33, 0xfe, 0xb8}},
		{name: "ldsetal w30, w30, [x30]", inst: LDSETALW, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x33, 0xfe, 0xb8}},
		{name: "ldsetalh wzr, wzr, [sp]", inst: LDSETALH, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x33, 0xff, 0x78}},
		{name: "ldsetalh wzr, w10, [sp]", inst: LDSETALH, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x33, 0xff, 0x78}},
		{name: "ldsetalh wzr, w30, [sp]", inst: LDSETALH, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x33, 0xff, 0x78}},
		{name: "ldsetalh wzr, wzr, [x10]", inst: LDSETALH, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x31, 0xff, 0x78}},
		{name: "ldsetalh wzr, w10, [x10]", inst: LDSETALH, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x31, 0xff, 0x78}},
		{name: "ldsetalh wzr, w30, [x10]", inst: LDSETALH, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x31, 0xff, 0x78}},
		{name: "ldsetalh wzr, wzr, [x30]", inst: LDSETALH, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x33, 0xff, 0x78}},
		{name: "ldsetalh wzr, w10, [x30]", inst: LDSETALH, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x33, 0xff, 0x78}},
		{name: "ldsetalh wzr, w30, [x30]", inst: LDSETALH, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x33, 0xff, 0x78}},
		{name: "ldsetalh w10, wzr, [sp]", inst: LDSETALH, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x33, 0xea, 0x78}},
		{name: "ldsetalh w10, w10, [sp]", inst: LDSETALH, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x33, 0xea, 0x78}},
		{name: "ldsetalh w10, w30, [sp]", inst: LDSETALH, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x33, 0xea, 0x78}},
		{name: "ldsetalh w10, wzr, [x10]", inst: LDSETALH, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x31, 0xea, 0x78}},
		{name: "ldsetalh w10, w10, [x10]", inst: LDSETALH, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x31, 0xea, 0x78}},
		{name: "ldsetalh w10, w30, [x10]", inst: LDSETALH, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x31, 0xea, 0x78}},
		{name: "ldsetalh w10, wzr, [x30]", inst: LDSETALH, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x33, 0xea, 0x78}},
		{name: "ldsetalh w10, w10, [x30]", inst: LDSETALH, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x33, 0xea, 0x78}},
		{name: "ldsetalh w10, w30, [x30]", inst: LDSETALH, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x33, 0xea, 0x78}},
		{name: "ldsetalh w30, wzr, [sp]", inst: LDSETALH, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x33, 0xfe, 0x78}},
		{name: "ldsetalh w30, w10, [sp]", inst: LDSETALH, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x33, 0xfe, 0x78}},
		{name: "ldsetalh w30, w30, [sp]", inst: LDSETALH, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x33, 0xfe, 0x78}},
		{name: "ldsetalh w30, wzr, [x10]", inst: LDSETALH, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x31, 0xfe, 0x78}},
		{name: "ldsetalh w30, w10, [x10]", inst: LDSETALH, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x31, 0xfe, 0x78}},
		{name: "ldsetalh w30, w30, [x10]", inst: LDSETALH, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x31, 0xfe, 0x78}},
		{name: "ldsetalh w30, wzr, [x30]", inst: LDSETALH, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x33, 0xfe, 0x78}},
		{name: "ldsetalh w30, w10, [x30]", inst: LDSETALH, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x33, 0xfe, 0x78}},
		{name: "ldsetalh w30, w30, [x30]", inst: LDSETALH, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x33, 0xfe, 0x78}},
		{name: "ldsetalb wzr, wzr, [sp]", inst: LDSETALB, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x33, 0xff, 0x38}},
		{name: "ldsetalb wzr, w10, [sp]", inst: LDSETALB, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x33, 0xff, 0x38}},
		{name: "ldsetalb wzr, w30, [sp]", inst: LDSETALB, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x33, 0xff, 0x38}},
		{name: "ldsetalb wzr, wzr, [x10]", inst: LDSETALB, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x31, 0xff, 0x38}},
		{name: "ldsetalb wzr, w10, [x10]", inst: LDSETALB, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x31, 0xff, 0x38}},
		{name: "ldsetalb wzr, w30, [x10]", inst: LDSETALB, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x31, 0xff, 0x38}},
		{name: "ldsetalb wzr, wzr, [x30]", inst: LDSETALB, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x33, 0xff, 0x38}},
		{name: "ldsetalb wzr, w10, [x30]", inst: LDSETALB, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x33, 0xff, 0x38}},
		{name: "ldsetalb wzr, w30, [x30]", inst: LDSETALB, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x33, 0xff, 0x38}},
		{name: "ldsetalb w10, wzr, [sp]", inst: LDSETALB, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x33, 0xea, 0x38}},
		{name: "ldsetalb w10, w10, [sp]", inst: LDSETALB, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x33, 0xea, 0x38}},
		{name: "ldsetalb w10, w30, [sp]", inst: LDSETALB, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x33, 0xea, 0x38}},
		{name: "ldsetalb w10, wzr, [x10]", inst: LDSETALB, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x31, 0xea, 0x38}},
		{name: "ldsetalb w10, w10, [x10]", inst: LDSETALB, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x31, 0xea, 0x38}},
		{name: "ldsetalb w10, w30, [x10]", inst: LDSETALB, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x31, 0xea, 0x38}},
		{name: "ldsetalb w10, wzr, [x30]", inst: LDSETALB, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x33, 0xea, 0x38}},
		{name: "ldsetalb w10, w10, [x30]", inst: LDSETALB, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x33, 0xea, 0x38}},
		{name: "ldsetalb w10, w30, [x30]", inst: LDSETALB, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x33, 0xea, 0x38}},
		{name: "ldsetalb w30, wzr, [sp]", inst: LDSETALB, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x33, 0xfe, 0x38}},
		{name: "ldsetalb w30, w10, [sp]", inst: LDSETALB, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x33, 0xfe, 0x38}},
		{name: "ldsetalb w30, w30, [sp]", inst: LDSETALB, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x33, 0xfe, 0x38}},
		{name: "ldsetalb w30, wzr, [x10]", inst: LDSETALB, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x31, 0xfe, 0x38}},
		{name: "ldsetalb w30, w10, [x10]", inst: LDSETALB, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x31, 0xfe, 0x38}},
		{name: "ldsetalb w30, w30, [x10]", inst: LDSETALB, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x31, 0xfe, 0x38}},
		{name: "ldsetalb w30, wzr, [x30]", inst: LDSETALB, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x33, 0xfe, 0x38}},
		{name: "ldsetalb w30, w10, [x30]", inst: LDSETALB, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x33, 0xfe, 0x38}},
		{name: "ldsetalb w30, w30, [x30]", inst: LDSETALB, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x33, 0xfe, 0x38}},
		{name: "ldeoral xzr, xzr, [sp]", inst: LDEORALD, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x23, 0xff, 0xf8}},
		{name: "ldeoral xzr, x10, [sp]", inst: LDEORALD, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x23, 0xff, 0xf8}},
		{name: "ldeoral xzr, x30, [sp]", inst: LDEORALD, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x23, 0xff, 0xf8}},
		...
		{name: "ldeoral xzr, xzr, [x30]", inst: LDEORALD, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x23, 0xff, 0xf8}},
		...
		{name: "ldeoral x10, xzr, [sp]", inst: LDEORALD, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x23, 0xea, 0xf8}},
		{name: "ldeoral x10, x10, [sp]", inst: LDEORALD, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x23, 0xea, 0xf8}},
		{name: "ldeoral x10, x30, [sp]", inst: LDEORALD, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x23, 0xea, 0xf8}},
		{name: "ldeoral x10, xzr, [x10]", inst: LDEORALD, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x21, 0xea, 0xf8}},
		{name: "ldeoral x10, x10, [x10]", inst: LDEORALD, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x21, 0xea, 0xf8}},
		{name: "ldeoral x10, x30, [x10]", inst: LDEORALD, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x21, 0xea, 0xf8}},
		{name: "ldeoral x10, xzr, [x30]", inst: LDEORALD, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x23, 0xea, 0xf8}},
		{name: "ldeoral x10, x10, [x30]", inst: LDEORALD, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x23, 0xea, 0xf8}},
		{name: "ldeoral x10, x30, [x30]", inst: LDEORALD, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x23, 0xea, 0xf8}},
		{name: "ldeoral x30, xzr, [sp]", inst: LDEORALD, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x23, 0xfe, 0xf8}},
		{name: "ldeoral x30, x10, [sp]", inst: LDEORALD, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x23, 0xfe, 0xf8}},
		{name: "ldeoral x30, x30, [sp]", inst: LDEORALD, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x23, 0xfe, 0xf8}},
		{name: "ldeoral x30, xzr, [x10]", inst: LDEORALD, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x21, 0xfe, 0xf8}},
		{name: "ldeoral x30, x10, [x10]", inst: LDEORALD, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x21, 0xfe, 0xf8}},
		{name: "ldeoral x30, x30, [x10]", inst: LDEORALD, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x21, 0xfe, 0xf8}},
		{name: "ldeoral x30, xzr, [x30]", inst: LDEORALD, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x23, 0xfe, 0xf8}},
		{name: "ldeoral x30, x10, [x30]", inst: LDEORALD, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x23, 0xfe, 0xf8}},
		{name: "ldeoral x30, x30, [x30]", inst: LDEORALD, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x23, 0xfe, 0xf8}},
		{name: "ldeoral wzr, wzr, [sp]", inst: LDEORALW, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x23, 0xff, 0xb8}},
		{name: "ldeoral wzr, w10, [sp]", inst: LDEORALW, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x23, 0xff, 0xb8}},
		{name: "ldeoral wzr, w30, [sp]", inst: LDEORALW, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x23, 0xff, 0xb8}},
		{name: "ldeoral wzr, wzr, [x10]", inst: LDEORALW, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x21, 0xff, 0xb8}},
		{name: "ldeoral wzr, w10, [x10]", inst: LDEORALW, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x21, 0xff, 0xb8}},
		{name: "ldeoral wzr, w30, [x10]", inst: LDEORALW, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x21, 0xff, 0xb8}},
		{name: "ldeoral wzr, wzr, [x30]", inst: LDEORALW, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x23, 0xff, 0xb8}},
		{name: "ldeoral wzr, w10, [x30]", inst: LDEORALW, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x23, 0xff, 0xb8}},
		{name: "ldeoral wzr, w30, [x30]", inst: LDEORALW, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x23, 0xff, 0xb8}},
		{name: "ldeoral w10, wzr, [sp]", inst: LDEORALW, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x23, 0xea, 0xb8}},
		{name: "ldeoral w10, w10, [sp]", inst: LDEORALW, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x23, 0xea, 0xb8}},
		{name: "ldeoral w10, w30, [sp]", inst: LDEORALW, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x23, 0xea, 0xb8}},
		{name: "ldeoral w10, wzr, [x10]", inst: LDEORALW, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x21, 0xea, 0xb8}},
		{name: "ldeoral w10, w10, [x10]", inst: LDEORALW, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x21, 0xea, 0xb8}},
		{name: "ldeoral w10, w30, [x10]", inst: LDEORALW, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x21, 0xea, 0xb8}},
		{name: "ldeoral w10, wzr, [x30]", inst: LDEORALW, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x23, 0xea, 0xb8}},
		{name: "ldeoral w10, w10, [x30]", inst: LDEORALW, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x23, 0xea, 0xb8}},
		{name: "ldeoral w10, w30, [x30]", inst: LDEORALW, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x23, 0xea, 0xb8}},
		{name: "ldeoral w30, wzr, [sp]", inst: LDEORALW, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x23, 0xfe, 0xb8}},
		{name: "ldeoral w30, w10, [sp]", inst: LDEORALW, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x23, 0xfe, 0xb8}},
		{name: "ldeoral w30, w30, [sp]", inst: LDEORALW, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x23, 0xfe, 0xb8}},
		{name: "ldeoral w30, wzr, [x10]", inst: LDEORALW, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x21, 0xfe, 0xb8}},
		{name: "ldeoral w30, w10, [x10]", inst: LDEORALW, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x21, 0xfe, 0xb8}},
		{name: "ldeoral w30, w30, [x10]", inst: LDEORALW, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x21, 0xfe, 0xb8}},
		{name: "ldeoral w30, wzr, [x30]", inst: LDEORALW, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x23, 0xfe, 0xb8}},
		{name: "ldeoral w30, w10, [x30]", inst: LDEORALW, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x23, 0xfe, 0xb8}},
		{name: "ldeoral w30, w30, [x30]", inst: LDEORALW, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x23, 0xfe, 0xb8}},
		{name: "ldeoralh wzr, wzr, [sp]", inst: LDEORALH, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x23, 0xff, 0x78}},
		{name: "ldeoralh wzr, w10, [sp]", inst: LDEORALH, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x23, 0xff, 0x78}},
		{name: "ldeoralh wzr, w30, [sp]", inst: LDEORALH, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x23, 0xff, 0x78}},
		{name: "ldeoralh wzr, wzr, [x10]", inst: LDEORALH, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x21, 0xff, 0x78}},
		{name: "ldeoralh wzr, w10, [x10]", inst: LDEORALH, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x21, 0xff, 0x78}},
		{name: "ldeoralh wzr, w30, [x10]", inst: LDEORALH, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x21, 0xff, 0x78}},
		{name: "ldeoralh wzr, wzr, [x30]", inst: LDEORALH, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x23, 0xff, 0x78}},
		{name: "ldeoralh wzr, w10, [x30]", inst: LDEORALH, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x23, 0xff, 0x78}},
		{name: "ldeoralh wzr, w30, [x30]", inst: LDEORALH, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x23, 0xff, 0x78}},
		{name: "ldeoralh w10, wzr, [sp]", inst: LDEORALH, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x23, 0xea, 0x78}},
		{name: "ldeoralh w10, w10, [sp]", inst: LDEORALH, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x23, 0xea, 0x78}},
		{name: "ldeoralh w10, w30, [sp]", inst: LDEORALH, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x23, 0xea, 0x78}},
		{name: "ldeoralh w10, wzr, [x10]", inst: LDEORALH, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x21, 0xea, 0x78}},
		{name: "ldeoralh w10, w10, [x10]", inst: LDEORALH, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x21, 0xea, 0x78}},
		{name: "ldeoralh w10, w30, [x10]", inst: LDEORALH, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x21, 0xea, 0x78}},
		{name: "ldeoralh w10, wzr, [x30]", inst: LDEORALH, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x23, 0xea, 0x78}},
		{name: "ldeoralh w10, w10, [x30]", inst: LDEORALH, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x23, 0xea, 0x78}},
		{name: "ldeoralh w10, w30, [x30]", inst: LDEORALH, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x23, 0xea, 0x78}},
		{name: "ldeoralh w30, wzr, [sp]", inst: LDEORALH, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x23, 0xfe, 0x78}},
		{name: "ldeoralh w30, w10, [sp]", inst: LDEORALH, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x23, 0xfe, 0x78}},
		{name: "ldeoralh w30, w30, [sp]", inst: LDEORALH, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x23, 0xfe, 0x78}},
		{name: "ldeoralh w30, wzr, [x10]", inst: LDEORALH, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x21, 0xfe, 0x78}},
		{name: "ldeoralh w30, w10, [x10]", inst: LDEORALH, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x21, 0xfe, 0x78}},
		{name: "ldeoralh w30, w30, [x10]", inst: LDEORALH, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x21, 0xfe, 0x78}},
		{name: "ldeoralh w30, wzr, [x30]", inst: LDEORALH, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x23, 0xfe, 0x78}},
		{name: "ldeoralh w30, w10, [x30]", inst: LDEORALH, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x23, 0xfe, 0x78}},
		{name: "ldeoralh w30, w30, [x30]", inst: LDEORALH, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x23, 0xfe, 0x78}},
		{name: "ldeoralb wzr, wzr, [sp]", inst: LDEORALB, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x23, 0xff, 0x38}},
		{name: "ldeoralb wzr, w10, [sp]", inst: LDEORALB, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x23, 0xff, 0x38}},
		{name: "ldeoralb wzr, w30, [sp]", inst: LDEORALB, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x23, 0xff, 0x38}},
		{name: "ldeoralb wzr, wzr, [x10]", inst: LDEORALB, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x21, 0xff, 0x38}},
		{name: "ldeoralb wzr, w10, [x10]", inst: LDEORALB, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x21, 0xff, 0x38}},
		{name: "ldeoralb wzr, w30, [x10]", inst: LDEORALB, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x21, 0xff, 0x38}},
		{name: "ldeoralb wzr, wzr, [x30]", inst: LDEORALB, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x23, 0xff, 0x38}},
		{name: "ldeoralb wzr, w10, [x30]", inst: LDEORALB, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x23, 0xff, 0x38}},
		{name: "ldeoralb wzr, w30, [x30]", inst: LDEORALB, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x23, 0xff, 0x38}},
		{name: "ldeoralb w10, wzr, [sp]", inst: LDEORALB, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x23, 0xea, 0x38}},
		{name: "ldeoralb w10, w10, [sp]", inst: LDEORALB, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x23, 0xea, 0x38}},
		{name: "ldeoralb w10, w30, [sp]", inst: LDEORALB, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x23, 0xea, 0x38}},
		{name: "ldeoralb w10, wzr, [x10]", inst: LDEORALB, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x21, 0xea, 0x38}},
		{name: "ldeoralb w10, w10, [x10]", inst: LDEORALB, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x21, 0xea, 0x38}},
		{name: "ldeoralb w10, w30, [x10]", inst: LDEORALB, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x21, 0xea, 0x38}},
		{name: "ldeoralb w10, wzr, [x30]", inst: LDEORALB, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x23, 0xea, 0x38}},
		{name: "ldeoralb w10, w10, [x30]", inst: LDEORALB, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x23, 0xea, 0x38}},
		{name: "ldeoralb w10, w30, [x30]", inst: LDEORALB, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x23, 0xea, 0x38}},
		{name: "ldeoralb w30, wzr, [sp]", inst: LDEORALB, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x23, 0xfe, 0x38}},
		{name: "ldeoralb w30, w10, [sp]", inst: LDEORALB, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x23, 0xfe, 0x38}},
		{name: "ldeoralb w30, w30, [sp]", inst: LDEORALB, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x23, 0xfe, 0x38}},
		{name: "ldeoralb w30, wzr, [x10]", inst: LDEORALB, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x21, 0xfe, 0x38}},
		{name: "ldeoralb w30, w10, [x10]", inst: LDEORALB, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x21, 0xfe, 0x38}},
		{name: "ldeoralb w30, w30, [x10]", inst: LDEORALB, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x21, 0xfe, 0x38}},
		{name: "ldeoralb w30, wzr, [x30]", inst: LDEORALB, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x23, 0xfe, 0x38}},
		{name: "ldeoralb w30, w10, [x30]", inst: LDEORALB, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x23, 0xfe, 0x38}},
		{name: "ldeoralb w30, w30, [x30]", inst: LDEORALB, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x23, 0xfe, 0x38}},
		{name: "swpal xzr, xzr, [sp]", inst: SWPALD, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x83, 0xff, 0xf8}},
		{name: "swpal xzr, x10, [sp]", inst: SWPALD, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x83, 0xff, 0xf8}},
		{name: "swpal xzr, x30, [sp]", inst: SWPALD, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x83, 0xff, 0xf8}},
		...
		{name: "swpal x10, xzr, [sp]", inst: SWPALD, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x83, 0xea, 0xf8}},
		{name: "swpal x10, x10, [sp]", inst: SWPALD, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x83, 0xea, 0xf8}},
		{name: "swpal x10, x30, [sp]", inst: SWPALD, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x83, 0xea, 0xf8}},
		{name: "swpal x10, xzr, [x10]", inst: SWPALD, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x81, 0xea, 0xf8}},
		{name: "swpal x10, x10, [x10]", inst: SWPALD, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x81, 0xea, 0xf8}},
		{name: "swpal x10, x30, [x10]", inst: SWPALD, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x81, 0xea, 0xf8}},
		{name: "swpal x10, xzr, [x30]", inst: SWPALD, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x83, 0xea, 0xf8}},
		{name: "swpal x10, x10, [x30]", inst: SWPALD, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x83, 0xea, 0xf8}},
		{name: "swpal x10, x30, [x30]", inst: SWPALD, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x83, 0xea, 0xf8}},
		{name: "swpal x30, xzr, [sp]", inst: SWPALD, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x83, 0xfe, 0xf8}},
		{name: "swpal x30, x10, [sp]", inst: SWPALD, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x83, 0xfe, 0xf8}},
		{name: "swpal x30, x30, [sp]", inst: SWPALD, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x83, 0xfe, 0xf8}},
		{name: "swpal x30, xzr, [x10]", inst: SWPALD, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x81, 0xfe, 0xf8}},
		{name: "swpal x30, x10, [x10]", inst: SWPALD, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x81, 0xfe, 0xf8}},
		{name: "swpal x30, x30, [x10]", inst: SWPALD, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x81, 0xfe, 0xf8}},
		{name: "swpal x30, xzr, [x30]", inst: SWPALD, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x83, 0xfe, 0xf8}},
		{name: "swpal x30, x10, [x30]", inst: SWPALD, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x83, 0xfe, 0xf8}},
		{name: "swpal x30, x30, [x30]", inst: SWPALD, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x83, 0xfe, 0xf8}},
		{name: "swpal wzr, wzr, [sp]", inst: SWPALW, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x83, 0xff, 0xb8}},
		{name: "swpal wzr, w10, [sp]", inst: SWPALW, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x83, 0xff, 0xb8}},
		{name: "swpal wzr, w30, [sp]", inst: SWPALW, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x83, 0xff, 0xb8}},
		{name: "swpal wzr, wzr, [x10]", inst: SWPALW, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x81, 0xff, 0xb8}},
		{name: "swpal wzr, w10, [x10]", inst: SWPALW, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x81, 0xff, 0xb8}},
		{name: "swpal wzr, w30, [x10]", inst: SWPALW, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x81, 0xff, 0xb8}},
		{name: "swpal wzr, wzr, [x30]", inst: SWPALW, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x83, 0xff, 0xb8}},
		{name: "swpal wzr, w10, [x30]", inst: SWPALW, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x83, 0xff, 0xb8}},
		{name: "swpal wzr, w30, [x30]", inst: SWPALW, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x83, 0xff, 0xb8}},
		{name: "swpal w10, wzr, [sp]", inst: SWPALW, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x83, 0xea, 0xb8}},
		{name: "swpal w10, w10, [sp]", inst: SWPALW, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x83, 0xea, 0xb8}},
		{name: "swpal w10, w30, [sp]", inst: SWPALW, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x83, 0xea, 0xb8}},
		{name: "swpal w10, wzr, [x10]", inst: SWPALW, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x81, 0xea, 0xb8}},
		{name: "swpal w10, w10, [x10]", inst: SWPALW, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x81, 0xea, 0xb8}},
		{name: "swpal w10, w30, [x10]", inst: SWPALW, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x81, 0xea, 0xb8}},
		{name: "swpal w10, wzr, [x30]", inst: SWPALW, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x83, 0xea, 0xb8}},
		{name: "swpal w10, w10, [x30]", inst: SWPALW, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x83, 0xea, 0xb8}},
		{name: "swpal w10, w30, [x30]", inst: SWPALW, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x83, 0xea, 0xb8}},
		{name: "swpal w30, wzr, [sp]", inst: SWPALW, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x83, 0xfe, 0xb8}},
		{name: "swpal w30, w10, [sp]", inst: SWPALW, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x83, 0xfe, 0xb8}},
		{name: "swpal w30, w30, [sp]", inst: SWPALW, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x83, 0xfe, 0xb8}},
		{name: "swpal w30, wzr, [x10]", inst: SWPALW, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x81, 0xfe, 0xb8}},
		{name: "swpal w30, w10, [x10]", inst: SWPALW, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x81, 0xfe, 0xb8}},
		{name: "swpal w30, w30, [x10]", inst: SWPALW, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x81, 0xfe, 0xb8}},
		{name: "swpal w30, wzr, [x30]", inst: SWPALW, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x83, 0xfe, 0xb8}},
		{name: "swpal w30, w10, [x30]", inst: SWPALW, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x83, 0xfe, 0xb8}},
		{name: "swpal w30, w30, [x30]", inst: SWPALW, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x83, 0xfe, 0xb8}},
		{name: "swpalh wzr, wzr, [sp]", inst: SWPALH, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x83, 0xff, 0x78}},
		{name: "swpalh wzr, w10, [sp]", inst: SWPALH, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x83, 0xff, 0x78}},
		{name: "swpalh wzr, w30, [sp]", inst: SWPALH, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x83, 0xff, 0x78}},
		{name: "swpalh wzr, wzr, [x10]", inst: SWPALH, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x81, 0xff, 0x78}},
		{name: "swpalh wzr, w10, [x10]", inst: SWPALH, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x81, 0xff, 0x78}},
		{name: "swpalh wzr, w30, [x10]", inst: SWPALH, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x81, 0xff, 0x78}},
		{name: "swpalh wzr, wzr, [x30]", inst: SWPALH, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x83, 0xff, 0x78}},
		{name: "swpalh wzr, w10, [x30]", inst: SWPALH, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x83, 0xff, 0x78}},
		{name: "swpalh wzr, w30, [x30]", inst: SWPALH, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x83, 0xff, 0x78}},
		{name: "swpalh w10, wzr, [sp]", inst: SWPALH, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x83, 0xea, 0x78}},
		{name: "swpalh w10, w10, [sp]", inst: SWPALH, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x83, 0xea, 0x78}},
		{name: "swpalh w10, w30, [sp]", inst: SWPALH, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x83, 0xea, 0x78}},
		{name: "swpalh w10, wzr, [x10]", inst: SWPALH, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x81, 0xea, 0x78}},
		{name: "swpalh w10, w10, [x10]", inst: SWPALH, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x81, 0xea, 0x78}},
		{name: "swpalh w10, w30, [x10]", inst: SWPALH, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x81, 0xea, 0x78}},
		{name: "swpalh w10, wzr, [x30]", inst: SWPALH, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x83, 0xea, 0x78}},
		{name: "swpalh w10, w10, [x30]", inst: SWPALH, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x83, 0xea, 0x78}},
		{name: "swpalh w10, w30, [x30]", inst: SWPALH, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x83, 0xea, 0x78}},
		{name: "swpalh w30, wzr, [sp]", inst: SWPALH, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x83, 0xfe, 0x78}},
		{name: "swpalh w30, w10, [sp]", inst: SWPALH, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x83, 0xfe, 0x78}},
		{name: "swpalh w30, w30, [sp]", inst: SWPALH, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x83, 0xfe, 0x78}},
		{name: "swpalh w30, wzr, [x10]", inst: SWPALH, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x81, 0xfe, 0x78}},
		{name: "swpalh w30, w10, [x10]", inst: SWPALH, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x81, 0xfe, 0x78}},
		{name: "swpalh w30, w30, [x10]", inst: SWPALH, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x81, 0xfe, 0x78}},
		{name: "swpalh w30, wzr, [x30]", inst: SWPALH, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x83, 0xfe, 0x78}},
		{name: "swpalh w30, w10, [x30]", inst: SWPALH, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x83, 0xfe, 0x78}},
		{name: "swpalh w30, w30, [x30]", inst: SWPALH, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x83, 0xfe, 0x78}},
		{name: "swpalb wzr, wzr, [sp]", inst: SWPALB, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x83, 0xff, 0x38}},
		{name: "swpalb wzr, w10, [sp]", inst: SWPALB, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x83, 0xff, 0x38}},
		{name: "swpalb wzr, w30, [sp]", inst: SWPALB, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x83, 0xff, 0x38}},
		{name: "swpalb wzr, wzr, [x10]", inst: SWPALB, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x81, 0xff, 0x38}},
		{name: "swpalb wzr, w10, [x10]", inst: SWPALB, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x81, 0xff, 0x38}},
		{name: "swpalb wzr, w30, [x10]", inst: SWPALB, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x81, 0xff, 0x38}},
		{name: "swpalb wzr, wzr, [x30]", inst: SWPALB, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x83, 0xff, 0x38}},
		{name: "swpalb wzr, w10, [x30]", inst: SWPALB, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x83, 0xff, 0x38}},
		{name: "swpalb wzr, w30, [x30]", inst: SWPALB, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x83, 0xff, 0x38}},
		{name: "swpalb w10, wzr, [sp]", inst: SWPALB, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x83, 0xea, 0x38}},
		{name: "swpalb w10, w10, [sp]", inst: SWPALB, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x83, 0xea, 0x38}},
		{name: "swpalb w10, w30, [sp]", inst: SWPALB, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x83, 0xea, 0x38}},
		{name: "swpalb w10, wzr, [x10]", inst: SWPALB, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x81, 0xea, 0x38}},
		{name: "swpalb w10, w10, [x10]", inst: SWPALB, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x81, 0xea, 0x38}},
		{name: "swpalb w10, w30, [x10]", inst: SWPALB, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x81, 0xea, 0x38}},
		{name: "swpalb w10, wzr, [x30]", inst: SWPALB, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x83, 0xea, 0x38}},
		{name: "swpalb w10, w10, [x30]", inst: SWPALB, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x83, 0xea, 0x38}},
		{name: "swpalb w10, w30, [x30]", inst: SWPALB, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x83, 0xea, 0x38}},
		{name: "swpalb w30, wzr, [sp]", inst: SWPALB, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0x83, 0xfe, 0x38}},
		{name: "swpalb w30, w10, [sp]", inst: SWPALB, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0x83, 0xfe, 0x38}},
		{name: "swpalb w30, w30, [sp]", inst: SWPALB, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0x83, 0xfe, 0x38}},
		{name: "swpalb w30, wzr, [x10]", inst: SWPALB, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0x81, 0xfe, 0x38}},
		{name: "swpalb w30, w10, [x10]", inst: SWPALB, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0x81, 0xfe, 0x38}},
		{name: "swpalb w30, w30, [x10]", inst: SWPALB, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0x81, 0xfe, 0x38}},
		{name: "swpalb w30, wzr, [x30]", inst: SWPALB, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0x83, 0xfe, 0x38}},
		{name: "swpalb w30, w10, [x30]", inst: SWPALB, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0x83, 0xfe, 0x38}},
		{name: "swpalb w30, w30, [x30]", inst: SWPALB, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0x83, 0xfe, 0x38}},
		{name: "casal xzr, xzr, [sp]", inst: CASALD, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0xff, 0xff, 0xc8}},
		{name: "casal xzr, x10, [sp]", inst: CASALD, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0xff, 0xff, 0xc8}},
		{name: "casal xzr, x30, [sp]", inst: CASALD, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0xff, 0xff, 0xc8}},
		{name: "casal xzr, xzr, [x10]", inst: CASALD, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0xfd, 0xff, 0xc8}},
		{name: "casal xzr, x10, [x10]", inst: CASALD, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0xfd, 0xff, 0xc8}},
		{name: "casal xzr, x30, [x10]", inst: CASALD, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0xfd, 0xff, 0xc8}},
		{name: "casal xzr, xzr, [x30]", inst: CASALD, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0xff, 0xff, 0xc8}},
		{name: "casal xzr, x10, [x30]", inst: CASALD, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0xff, 0xff, 0xc8}},
		{name: "casal xzr, x30, [x30]", inst: CASALD, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0xff, 0xff, 0xc8}},
		{name: "casal x10, xzr, [sp]", inst: CASALD, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0xff, 0xea, 0xc8}},
		{name: "casal x10, x10, [sp]", inst: CASALD, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0xff, 0xea, 0xc8}},
		{name: "casal x10, x30, [sp]", inst: CASALD, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0xff, 0xea, 0xc8}},
		{name: "casal x10, xzr, [x10]", inst: CASALD, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0xfd, 0xea, 0xc8}},
		{name: "casal x10, x10, [x10]", inst: CASALD, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0xfd, 0xea, 0xc8}},
		{name: "casal x10, x30, [x10]", inst: CASALD, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0xfd, 0xea, 0xc8}},
		{name: "casal x10, xzr, [x30]", inst: CASALD, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0xff, 0xea, 0xc8}},
		{name: "casal x10, x10, [x30]", inst: CASALD, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0xff, 0xea, 0xc8}},
		{name: "casal x10, x30, [x30]", inst: CASALD, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0xff, 0xea, 0xc8}},
		{name: "casal x30, xzr, [sp]", inst: CASALD, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0xff, 0xfe, 0xc8}},
		{name: "casal x30, x10, [sp]", inst: CASALD, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0xff, 0xfe, 0xc8}},
		{name: "casal x30, x30, [sp]", inst: CASALD, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0xff, 0xfe, 0xc8}},
		{name: "casal x30, xzr, [x10]", inst: CASALD, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0xfd, 0xfe, 0xc8}},
		{name: "casal x30, x10, [x10]", inst: CASALD, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0xfd, 0xfe, 0xc8}},
		{name: "casal x30, x30, [x10]", inst: CASALD, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0xfd, 0xfe, 0xc8}},
		{name: "casal x30, xzr, [x30]", inst: CASALD, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0xff, 0xfe, 0xc8}},
		{name: "casal x30, x10, [x30]", inst: CASALD, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0xff, 0xfe, 0xc8}},
		{name: "casal x30, x30, [x30]", inst: CASALD, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0xff, 0xfe, 0xc8}},
		{name: "casal wzr, wzr, [sp]", inst: CASALW, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0xff, 0xff, 0x88}},
		{name: "casal wzr, w10, [sp]", inst: CASALW, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0xff, 0xff, 0x88}},
		{name: "casal wzr, w30, [sp]", inst: CASALW, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0xff, 0xff, 0x88}},
		{name: "casal wzr, wzr, [x10]", inst: CASALW, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0xfd, 0xff, 0x88}},
		{name: "casal wzr, w10, [x10]", inst: CASALW, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0xfd, 0xff, 0x88}},
		{name: "casal wzr, w30, [x10]", inst: CASALW, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0xfd, 0xff, 0x88}},
		{name: "casal wzr, wzr, [x30]", inst: CASALW, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0xff, 0xff, 0x88}},
		{name: "casal wzr, w10, [x30]", inst: CASALW, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0xff, 0xff, 0x88}},
		{name: "casal wzr, w30, [x30]", inst: CASALW, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0xff, 0xff, 0x88}},
		{name: "casal w10, wzr, [sp]", inst: CASALW, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0xff, 0xea, 0x88}},
		{name: "casal w10, w10, [sp]", inst: CASALW, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0xff, 0xea, 0x88}},
		{name: "casal w10, w30, [sp]", inst: CASALW, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0xff, 0xea, 0x88}},
		{name: "casal w10, wzr, [x10]", inst: CASALW, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0xfd, 0xea, 0x88}},
		{name: "casal w10, w10, [x10]", inst: CASALW, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0xfd, 0xea, 0x88}},
		{name: "casal w10, w30, [x10]", inst: CASALW, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0xfd, 0xea, 0x88}},
		{name: "casal w10, wzr, [x30]", inst: CASALW, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0xff, 0xea, 0x88}},
		{name: "casal w10, w10, [x30]", inst: CASALW, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0xff, 0xea, 0x88}},
		{name: "casal w10, w30, [x30]", inst: CASALW, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0xff, 0xea, 0x88}},
		{name: "casal w30, wzr, [sp]", inst: CASALW, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0xff, 0xfe, 0x88}},
		{name: "casal w30, w10, [sp]", inst: CASALW, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0xff, 0xfe, 0x88}},
		{name: "casal w30, w30, [sp]", inst: CASALW, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0xff, 0xfe, 0x88}},
		{name: "casal w30, wzr, [x10]", inst: CASALW, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0xfd, 0xfe, 0x88}},
		{name: "casal w30, w10, [x10]", inst: CASALW, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0xfd, 0xfe, 0x88}},
		{name: "casal w30, w30, [x10]", inst: CASALW, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0xfd, 0xfe, 0x88}},
		{name: "casal w30, wzr, [x30]", inst: CASALW, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0xff, 0xfe, 0x88}},
		{name: "casal w30, w10, [x30]", inst: CASALW, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0xff, 0xfe, 0x88}},
		{name: "casal w30, w30, [x30]", inst: CASALW, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0xff, 0xfe, 0x88}},
		{name: "casalh wzr, wzr, [sp]", inst: CASALH, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0xff, 0xff, 0x48}},
		{name: "casalh wzr, w10, [sp]", inst: CASALH, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0xff, 0xff, 0x48}},
		{name: "casalh wzr, w30, [sp]", inst: CASALH, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0xff, 0xff, 0x48}},
		{name: "casalh wzr, wzr, [x10]", inst: CASALH, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0xfd, 0xff, 0x48}},
		{name: "casalh wzr, w10, [x10]", inst: CASALH, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0xfd, 0xff, 0x48}},
		{name: "casalh wzr, w30, [x10]", inst: CASALH, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0xfd, 0xff, 0x48}},
		{name: "casalh wzr, wzr, [x30]", inst: CASALH, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0xff, 0xff, 0x48}},
		{name: "casalh wzr, w10, [x30]", inst: CASALH, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0xff, 0xff, 0x48}},
		{name: "casalh wzr, w30, [x30]", inst: CASALH, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0xff, 0xff, 0x48}},
		{name: "casalh w10, wzr, [sp]", inst: CASALH, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0xff, 0xea, 0x48}},
		{name: "casalh w10, w10, [sp]", inst: CASALH, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0xff, 0xea, 0x48}},
		{name: "casalh w10, w30, [sp]", inst: CASALH, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0xff, 0xea, 0x48}},
		{name: "casalh w10, wzr, [x10]", inst: CASALH, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0xfd, 0xea, 0x48}},
		{name: "casalh w10, w10, [x10]", inst: CASALH, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0xfd, 0xea, 0x48}},
		{name: "casalh w10, w30, [x10]", inst: CASALH, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0xfd, 0xea, 0x48}},
		{name: "casalh w10, wzr, [x30]", inst: CASALH, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0xff, 0xea, 0x48}},
		{name: "casalh w10, w10, [x30]", inst: CASALH, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0xff, 0xea, 0x48}},
		{name: "casalh w10, w30, [x30]", inst: CASALH, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0xff, 0xea, 0x48}},
		{name: "casalh w30, wzr, [sp]", inst: CASALH, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0xff, 0xfe, 0x48}},
		{name: "casalh w30, w10, [sp]", inst: CASALH, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0xff, 0xfe, 0x48}},
		{name: "casalh w30, w30, [sp]", inst: CASALH, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0xff, 0xfe, 0x48}},
		{name: "casalh w30, wzr, [x10]", inst: CASALH, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0xfd, 0xfe, 0x48}},
		{name: "casalh w30, w10, [x10]", inst: CASALH, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0xfd, 0xfe, 0x48}},
		{name: "casalh w30, w30, [x10]", inst: CASALH, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0xfd, 0xfe, 0x48}},
		{name: "casalh w30, wzr, [x30]", inst: CASALH, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0xff, 0xfe, 0x48}},
		{name: "casalh w30, w10, [x30]", inst: CASALH, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0xff, 0xfe, 0x48}},
		{name: "casalh w30, w30, [x30]", inst: CASALH, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0xff, 0xfe, 0x48}},
		{name: "casalb wzr, wzr, [sp]", inst: CASALB, src: RegRZR, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0xff, 0xff, 0x8}},
		{name: "casalb wzr, w10, [sp]", inst: CASALB, src: RegRZR, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0xff, 0xff, 0x8}},
		{name: "casalb wzr, w30, [sp]", inst: CASALB, src: RegRZR, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0xff, 0xff, 0x8}},
		{name: "casalb wzr, wzr, [x10]", inst: CASALB, src: RegRZR, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0xfd, 0xff, 0x8}},
		{name: "casalb wzr, w10, [x10]", inst: CASALB, src: RegRZR, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0xfd, 0xff, 0x8}},
		{name: "casalb wzr, w30, [x10]", inst: CASALB, src: RegRZR, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0xfd, 0xff, 0x8}},
		{name: "casalb wzr, wzr, [x30]", inst: CASALB, src: RegRZR, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0xff, 0xff, 0x8}},
		{name: "casalb wzr, w10, [x30]", inst: CASALB, src: RegRZR, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0xff, 0xff, 0x8}},
		{name: "casalb wzr, w30, [x30]", inst: CASALB, src: RegRZR, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0xff, 0xff, 0x8}},
		{name: "casalb w10, wzr, [sp]", inst: CASALB, src: RegR10, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0xff, 0xea, 0x8}},
		{name: "casalb w10, w10, [sp]", inst: CASALB, src: RegR10, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0xff, 0xea, 0x8}},
		{name: "casalb w10, w30, [sp]", inst: CASALB, src: RegR10, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0xff, 0xea, 0x8}},
		{name: "casalb w10, wzr, [x10]", inst: CASALB, src: RegR10, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0xfd, 0xea, 0x8}},
		{name: "casalb w10, w10, [x10]", inst: CASALB, src: RegR10, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0xfd, 0xea, 0x8}},
		{name: "casalb w10, w30, [x10]", inst: CASALB, src: RegR10, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0xfd, 0xea, 0x8}},
		{name: "casalb w10, wzr, [x30]", inst: CASALB, src: RegR10, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0xff, 0xea, 0x8}},
		{name: "casalb w10, w10, [x30]", inst: CASALB, src: RegR10, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0xff, 0xea, 0x8}},
		{name: "casalb w10, w30, [x30]", inst: CASALB, src: RegR10, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0xff, 0xea, 0x8}},
		{name: "casalb w30, wzr, [sp]", inst: CASALB, src: RegR30, src2: RegRZR, dst: RegRZR, exp: []byte{0xff, 0xff, 0xfe, 0x8}},
		{name: "casalb w30, w10, [sp]", inst: CASALB, src: RegR30, src2: RegRZR, dst: RegR10, exp: []byte{0xea, 0xff, 0xfe, 0x8}},
		{name: "casalb w30, w30, [sp]", inst: CASALB, src: RegR30, src2: RegRZR, dst: RegR30, exp: []byte{0xfe, 0xff, 0xfe, 0x8}},
		{name: "casalb w30, wzr, [x10]", inst: CASALB, src: RegR30, src2: RegR10, dst: RegRZR, exp: []byte{0x5f, 0xfd, 0xfe, 0x8}},
		{name: "casalb w30, w10, [x10]", inst: CASALB, src: RegR30, src2: RegR10, dst: RegR10, exp: []byte{0x4a, 0xfd, 0xfe, 0x8}},
		{name: "casalb w30, w30, [x10]", inst: CASALB, src: RegR30, src2: RegR10, dst: RegR30, exp: []byte{0x5e, 0xfd, 0xfe, 0x8}},
		{name: "casalb w30, wzr, [x30]", inst: CASALB, src: RegR30, src2: RegR30, dst: RegRZR, exp: []byte{0xdf, 0xff, 0xfe, 0x8}},
		{name: "casalb w30, w10, [x30]", inst: CASALB, src: RegR30, src2: RegR30, dst: RegR10, exp: []byte{0xca, 0xff, 0xfe, 0x8}},
		{name: "casalb w30, w30, [x30]", inst: CASALB, src: RegR30, src2: RegR30, dst: RegR30, exp: []byte{0xde, 0xff, 0xfe, 0x8}},
