...
func TestAssemblerImpl_ResolveForwardRelativeJumps(t *testing.T) {
	t.Run("long jump", func(t *testing.T) {
		t.Run("error", func(t *testing.T) {
			...
			target := &nodeImpl{offsetInBinaryField: targetOffset, forwardJumpOrigins: origin, forwardJumpOriginsHead: true}
			a := NewAssembler()
		...
		t.Run("ok", func(t *testing.T) {
			...
			for _, tt := range tests {
				...
				target := &nodeImpl{offsetInBinaryField: tc.targetOffset, forwardJumpOrigins: origin, forwardJumpOriginsHead: true}
				a := NewAssembler()
