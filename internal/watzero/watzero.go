...
import (
	...
	"github.com/tetratelabs/watzero/text"
	internalwasm "github.com/tetratelabs/watzero/wasm"
)
...
func Wat2Wasm(wat string) ([]byte, error) {
	if m, err := text.DecodeModule([]byte(wat), internalwasm.Features20220419); err != nil {
		return nil, err
	} else {
