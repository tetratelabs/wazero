...
// SectionIDFunction is the size of the function index space.
...
// is the size of the table index space.
...
// SectionIDMemory is the size of the memory index space.
...
// SectionIDGlobal is the size of the global index space.
