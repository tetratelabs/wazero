...
// * functions are the function index space, which is prefixed by imports. The value is the TypeSection index.
// * globals are the global index space, which is prefixed by imports.
