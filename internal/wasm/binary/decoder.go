...
func DecodeModule(
	...
	for {
		...
		case wasm.SectionIDImport:
			m.ImportSection, m.ImportFunctionCount, m.ImportGlobalCount,
				m.ImportMemoryCount, m.ImportTableCount, m.ImportModuleNames, err = decodeImportSection(r, memorySizer, memoryLimitPages, enabledFeatures)
			if err != nil {
