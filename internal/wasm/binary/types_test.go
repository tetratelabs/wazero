...
func TestEncodeFunctionType(t *testing.T) {
	i32, i64 := wasm2.ValueTypeI32, wasm2.ValueTypeI64
	tests := []struct {
		name     string
		...
		},
		{
			...
			input:    &wasm.FunctionType{Results: []wasm2.ValueType{i32, i64}},
		...
		},
		{
			...
			input:    &wasm.FunctionType{Params: []wasm2.ValueType{i64}, Results: []wasm2.ValueType{i32, i64}},
			expected: []byte{0x60, 1, i64, 2, i32, i64},
		},
		{
			name:     "two param one result",
			input:    &wasm.FunctionType{Params: []wasm2.ValueType{i32, i64}, Results: []wasm2.ValueType{i32}},
		...
		},
		{
			...
			input:    &wasm.FunctionType{Params: []wasm2.ValueType{i32, i64}, Results: []wasm2.ValueType{i32, i64}},
