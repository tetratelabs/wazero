...
func TestEncodeFunctionType(t *testing.T) {
	...
	tests := []struct {
		name     string
		input    *internalwasm.FunctionType
		expected []byte
	}{
		{
			name:     "empty",
		...
		},
		{
			...
			input:    &internalwasm.FunctionType{Params: []wasm.ValueType{i32}},
			expected: []byte{0x60, 1, i32, 0},
		},
		{
			name:     "undefined param no result", // ensure future spec changes don't panic
			input:    &internalwasm.FunctionType{Params: []wasm.ValueType{0x6f}},
			expected: []byte{0x60, 1, 0x6f, 0},
		},
		{
			name:     "no param one result",
			input:    &internalwasm.FunctionType{Results: []wasm.ValueType{i32}},
			expected: []byte{0x60, 0, 1, i32},
		},
		{
			name:     "no param undefined result", // ensure future spec changes don't panic
			input:    &internalwasm.FunctionType{Results: []wasm.ValueType{0x6f}},
			expected: []byte{0x60, 0, 1, 0x6f},
		},
		{
			name:     "one param one result",
			input:    &internalwasm.FunctionType{Params: []wasm.ValueType{i64}, Results: []wasm.ValueType{i32}},
			expected: []byte{0x60, 1, i64, 1, i32},
		},
		{
			name:     "undefined param undefined result", // ensure future spec changes don't panic
			input:    &internalwasm.FunctionType{Params: []wasm.ValueType{0x6f}, Results: []wasm.ValueType{0x6f}},
			expected: []byte{0x60, 1, 0x6f, 1, 0x6f},
		},
		{
			name:     "two params no result",
			input:    &internalwasm.FunctionType{Params: []wasm.ValueType{i32, i64}},
		...
		},
		{
			...
			input:    &internalwasm.FunctionType{Results: []wasm.ValueType{i32, i64}},
		...
		},
		{
			...
			input:    &internalwasm.FunctionType{Params: []wasm.ValueType{i64}, Results: []wasm.ValueType{i32, i64}},
			expected: []byte{0x60, 1, i64, 2, i32, i64},
		},
		{
			name:     "two param one result",
			input:    &internalwasm.FunctionType{Params: []wasm.ValueType{i32, i64}, Results: []wasm.ValueType{i32}},
		...
		},
		{
			...
			input:    &internalwasm.FunctionType{Params: []wasm.ValueType{i32, i64}, Results: []wasm.ValueType{i32, i64}},
