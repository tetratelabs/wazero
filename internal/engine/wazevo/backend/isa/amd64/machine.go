...
func (m *machine) prepareDivRemSigned(si *ssa.Instruction, isDiv bool, _64 bool, yr operand, xr operand, ctxVReg regalloc.VReg, ifRemNeg1 *instruction) *instruction {
	var neg1 uint64
	if _64 {
