...
type FunctionDefinition interface {
	...
	// DebugName returns the best non-empty name available for this function.
	//
	// For example, If DWARF is available, this will match the original source
	// code name.  Otherwise, this returns Name when non-empty or a generated
